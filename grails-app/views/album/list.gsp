		...
		<div data-role="content">
			...
			<ul data-role="listview" data-split-icon="gear" data-filter="true">
				<g:each in="${albumInstanceList}" status="i" var="albumInstance">
					<li>
						<g:link action="show" id="${albumInstance.id}">${albumInstance}</g:link>
						<g:link action="edit" id="${albumInstance.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
					</li>
				</g:each>
			</ol>
