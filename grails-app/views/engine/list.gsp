		...
		<div data-role="content">
			...
			<ul data-role="listview" data-split-icon="gear" data-filter="true">
				<g:each in="${engineInstanceList}" status="i" var="engineInstance">
					<li>
						<g:link action="show" id="${engineInstance.id}">${engineInstance}</g:link>
						<g:link action="edit" id="${engineInstance.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
					</li>
				</g:each>
			</ol>
