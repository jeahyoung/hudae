		...
		<div data-role="content">
			...
			<ul data-role="listview" data-split-icon="gear" data-filter="true">
				<g:each in="${songInstanceList}" status="i" var="songInstance">
					<li>
						<g:link action="show" id="${songInstance.id}">${songInstance}</g:link>
						<g:link action="edit" id="${songInstance.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
					</li>
				</g:each>
			</ol>
